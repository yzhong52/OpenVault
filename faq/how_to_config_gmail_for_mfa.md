...
LedgerAgent can read MFA codes from your Gmail inbox automatically using IMAP and a Google App Password.
...
5. Give it a name (e.g. `LedgerAgent`) and click **Create**
...
Not every institution supports email-based MFA. If yours sends codes to your phone, you can forward those SMS messages to your Gmail inbox and LedgerAgent will pick them up the same way.
